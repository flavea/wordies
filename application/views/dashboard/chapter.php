 ...
 <div id="chapter" class="uk-container uk-container-small uk-margin-large">
 	<div class="uk-margin">
 		<input class="uk-input uk-form-large uk-form-blank" type="text" placeholder="Chapter Name">
 	</div>
 	...
 	<div class="uk-margin-medium-top">
 		<h1 class="uk-heading-divider">
 			<span>Sections</span>
 			<a class="uk-icon-button uk-float-right uk-background-secondary uk-light uk-margin-medium-top" uk-icon="icon: plus; ratio: .7" title="Add Sections" uk-tooltip></a>
 		</h1>
