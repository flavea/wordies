...
<div class="uk-margin">
	<select class="uk-input characters" name="character" id="charid2" <?php if($permission == 1) echo "readonly"; ?>>

	</select>
</div>
<div class="uk-margin">
	<textarea class="tinymce uk-textarea" rows="5" placeholder="Textarea" id="rel-desc" required <?php if($permission == 1) echo "readonly"; ?>><?php echo $relation[0]->desc ?></textarea>
</div>
<?php if($permission > 2) { ?>
